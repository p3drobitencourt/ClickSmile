...
public class AgendamentoService {
    ...
    public AgendamentoService(AgendamentoRepository agendamentoRepository, UsuarioRepository usuarioRepository, PacienteRepository pacienteRepository) {
        ...
        agendamento.setFimAt(dto.dataHora().plusMinutes(30));
